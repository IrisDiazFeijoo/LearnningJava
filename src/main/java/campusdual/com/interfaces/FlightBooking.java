...
public class  FlightBooking implements IBooking{
    ...
    public void getTicketDatail() {
        if (this.bookedSeat.isEmpty()) {
            System.out.println("Flight " + this.flightNumber + "(" + this.company + " ), for date " + this.sdf.format(this.bookDate) + " has a seat  booked: " + this.bookedSeat);// el valor de la expresión es true
        }else {
